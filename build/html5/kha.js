...
var gameObjects_Ball = function(stage,x,y,spdX,spdY,collisions,maxHp) {
	...
	this.ball.colorMultiplication(this.colorRed,this.colorGreen,this.colorBlue);
...
gameObjects_Ball.prototype = $extend(com_framework_utils_Entity.prototype,{
	...
	,damage: function(dmg) {
		this.hp -= dmg;
		this.ball.colorMultiplication(this.colorRed + (1 - this.colorRed) / this.hpTotal * (this.hpTotal - this.hp),this.colorGreen + (1 - this.colorGreen) / this.hpTotal * (this.hpTotal - this.hp),this.colorBlue + (1 - this.colorBlue) / this.hpTotal * (this.hpTotal - this.hp));
		if(this.hp <= 0) {
			this.dead = true;
			this.ball.removeFromParent();
			this.hpDisplay.removeFromParent();
...
var gameObjects_Bullet = function() {
	...
	this.collision.height = 5;
	this.collision.userData = this;
	this.display = new com_gEngine_display_Sprite("arrow");
...
gameObjects_Gun.prototype = $extend(com_framework_utils_Entity.prototype,{
	...
	,shoot: function(aX,aY,dirX,dirY) {
		this.recycle(gameObjects_Bullet).shoot(aX,aY,dirX,dirY,this.bulletsCollisions);
	}
	,add_damage: function() {
		this.damage++;
	}
...
var gameObjects_PowerUp = function(x,y,powerUpCollision,layer) {
	...
	this.display.timeline.playAnimation("Idle");
	this.layer = layer;
	this.layer.addChild(this.display);
	com_soundLib_SoundManager.playFx(kha_Assets.sounds.fairyName,false);
};
$hxClasses["gameObjects.PowerUp"] = gameObjects_PowerUp;
gameObjects_PowerUp.__name__ = "gameObjects.PowerUp";
gameObjects_PowerUp.__super__ = com_framework_utils_Entity;
gameObjects_PowerUp.prototype = $extend(com_framework_utils_Entity.prototype,{
	collision: null
	,velocity: null
	,display: null
	,heyListen: null
	...
	,update: function(dt) {
		...
		if(this.collision.y + this.collision.height >= 690 && this.velocity.y > 0) {
			this.velocity.y = 0;
			this.velocity.x = 0;
		}
		this.collision.y += this.velocity.y * dt;
		this.collision.velocityY = this.velocity.y;
		this.collision.velocityX = this.velocity.x;
		if(this.collision.x >= com_gEngine_GEngine.virtualWidth) {
			this.collision.x = com_gEngine_GEngine.virtualWidth - 10;
		}
		...
		if(this.currentTime % 2 < 1 && this.velocity.y == 0 && !this.soundPlayed && !this.textTime) {
			...
			this.layer.addChild(this.heyListen);
			com_soundLib_SoundManager.playFx(kha_Assets.sounds.heyListenName,false);
		}
...
var kha__$Assets_ImageList = function() {
	this.titleDescription = { name : "title", original_height : 363, file_sizes : [573485], original_width : 1012, files : ["title.png"], type : "image"};
...
kha__$Assets_ImageList.prototype = {
	...
	,hey_listen: null
	,hey_listenName: null
	,hey_listenDescription: null
	,malePlayer: null
	,malePlayerDescription: null
	,navi: null
	,naviName: null
...
var kha__$Assets_SoundList = function() {
	this.heyListenDescription = { name : "heyListen", file_sizes : [14925,18174], files : ["heyListen.ogg","heyListen.mp4"], type : "sound"};
	this.heyListenName = "heyListen";
	this.heyListen = null;
	this.fairyDescription = { name : "fairy", file_sizes : [12858,16227], files : ["fairy.ogg","fairy.mp4"], type : "sound"};
	this.fairyName = "fairy";
	this.fairy = null;
	this.backgroundDescription = { name : "background", file_sizes : [2443714,2751023], files : ["background.ogg","background.mp4"], type : "sound"};
...
kha__$Assets_SoundList.prototype = {
	...
	,fairy: null
	,fairyName: null
	,fairyDescription: null
	,heyListen: null
	,heyListenName: null
	,heyListenDescription: null
...
kha__$Assets_BlobList.prototype = {
	femalePlayer_xml: null
	,femalePlayer_xmlDescription: null
	,malePlayer_xml: null
	,malePlayer_xmlDescription: null
...
var levelObjects_LoopBackground = function(sprite,layer,camera) {
	com_framework_utils_Entity.call(this);
	this.sprites = [];
	var _g = 0;
	while(_g < 35) {
...
$hxClasses["levelObjects.LoopBackground"] = levelObjects_LoopBackground;
...
states_GameState.prototype = $extend(com_framework_utils_State.prototype,{
	...
	,load: function(resources) {
		...
		resources.add(new com_loading_basicResources_SoundLoader(kha_Assets.sounds.heyListenName));
		resources.add(atlas);
	}
	,playerChar: null
	,simulationLayer: null
	...
	,init: function() {
		...
		this.powerUpCollision = new com_collision_platformer_CollisionGroup();
	...
	,ballVsBullet: function(aBall,aBullet) {
		...
		if(ball.get_hp() <= 0) {
			if(Math.floor(Math.random() * 4) + this.luckHelper >= 3) {
				this.addChild(new gameObjects_PowerUp(ball.get_x(),ball.get_y(),this.powerUpCollision,this.simulationLayer));
				this.luckHelper = 0;
			} else {
				this.luckHelper++;
			}
...
states_IntroScreen.prototype = $extend(com_framework_utils_State.prototype,{
	...
	,init: function() {
		...
		var tmp1 = this.title.width() * 0.5 / 25 * 12;
...
states_LoadingBar.prototype = $extend(com_framework_utils_State.prototype,{
	...
	,init: function() {
		...
		var title = new com_gEngine_display_Sprite("title");
		title.scaleX = 0.48;
		title.scaleY = 0.48;
...
states_SuccessScreen.prototype = $extend(com_framework_utils_State.prototype,{
	...
	,init: function() {
		var image = new com_gEngine_display_Sprite("stageComplete");
		this.simulationLayer = new com_gEngine_display_Layer();
		this.stage.addChild(this.simulationLayer);
		this.display = new com_gEngine_display_Sprite(this.sprite);
		this.display.x = 170;
